# api/employee_search_router.py
from fastapi import APIRouter, Depends, Request, Header
from sqlalchemy.orm import Session
from typing import List, Any

from app.schemas.employee_schema import EmployeeRead, PaginationResponse
from app.services.employee_search_service import EmployeeService
from app.core.database import get_db
from app.api.employee_search_param import EmployeeSearchParams
